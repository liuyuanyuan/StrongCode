...
<img src="images/jvm-structure.png" alt="image-20200227185734825" style="zoom:50%;" />

- .java 文件编译后生成 .class 文件后， **类加载子系统** 将class文件加载到内存中；

- JVM在执行Java程序时会将其管理的内存划分为几个**运行时数据区域**（堆、方法区，虚拟机栈、本地方法栈、程序计数器），他们有各自的生命周期和用途；
...
##### 3程序计数器（Program Counter Register）
